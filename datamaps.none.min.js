! function () {
    ...
    function b(a, b, c) {
        return this.svg = n.select(a).append("svg").attr("width", c || a.offsetWidth).attr("data-width", c || a.offsetWidth).attr("class", "datamap").attr("height", b || a.offsetHeight).style("overflow", "hidden"), this.options.responsive && (n.select(this.options.element).style(), n.select(this.options.element).select("svg").style({
            "margin-left": "10px",
            "margin-top": "-120px",
            width: "100%",
            height: "120%"
